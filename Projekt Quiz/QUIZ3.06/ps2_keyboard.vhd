            ...
            if received = '1' then
                ...
                case state is
                    ...
                    when 0 => 
						  ...
						  --escape - reset
						  if scancode = x"76" then
						  reset_out<='1';
						  
						  
						  --enter - rozpoczecie gry
						  elsif scancode = x"5a" then
						  set_rng<='1';
						  ...
						  --1
						  if scancode = x"16" then
						  answer_ASCII:=49;
						  
						  --2
						  elsif scancode = x"1e" then
						  answer_ASCII:=50;
						  
						  --3
						  elsif scancode = x"26" then
						  answer_ASCII:=51;
						  
						  --4
						  elsif scancode = x"25" then
						  answer_ASCII:=52;
						  
						  --esc
						  elsif scancode = x"76" then
						  reset_out<='1';
